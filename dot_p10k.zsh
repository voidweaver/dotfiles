# Generated by Powerlevel10k configuration wizard on 2020-04-18 at 16:41 +07.
...
# dotted, no frame, dark-ornaments, sparse, few icons, fluent, instant_prompt=verbose.
...
() {
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=213
  ...
  ######################################[ ram: free RAM ]#######################################
  # RAM color.
  typeset -g POWERLEVEL9K_RAM_FOREGROUND=227
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_LOAD_WARNING_FOREGROUND=172
